...
<div id="<?php print $player_id . '-interface'; ?>" class="jp-interface">
    <ul class="jp-controls">
      ...
      <li><a href="#" id="<?php print $player_id; ?>-mute" class="jp-mute" title="<?php print t('mute'); ?>"><?php print t('mute'); ?></a></li>
      <li><a href="#" id="<?php print $player_id; ?>-unmute" class="jp-unmute" title="<?php print t('unmute'); ?>"><?php print t('unmute'); ?></a></li>
    ...
    <div id="<?php print $player_id; ?>-progress" class="jp-progress" title="<?php print t('progress'); ?>">
      <div id="<?php print $player_id; ?>-seek-bar" class="jp-seek-bar">
    ...
    <div id="<?php print $player_id; ?>-current-time" class="jp-current-time"></div>
    <div id="<?php print $player_id; ?>-duration" class="jp-duration"></div>
  </div>
